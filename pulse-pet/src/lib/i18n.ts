...
const zh: Dict = {
  ...
  "integrations.uninstallHint": "修改前自动备份至同目录；卸载 PulsePet 前请先在此卸载各接入——卸载应用不会自动移除插件文件",
...
const en: Dict = {
  ...
  "integrations.uninstallHint": "Changes are backed up automatically to the same directory; uninstall integrations here before uninstalling PulsePet — uninstalling the app does not remove plugin files",
  "integrations.opencodeDesc": "opencode",
  "integrations.claudeDesc": "Claude Code",
